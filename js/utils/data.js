import {getFloatFromRange, getIntegerFromRange} from './random.js';
...
const indexes = Array.from({length: HOUSING_QUANTITY}, (empty, value) => ++value).sort(() => 0.5 - Math.random());
...
export {HOUSING_QUANTITY, createHousing};
